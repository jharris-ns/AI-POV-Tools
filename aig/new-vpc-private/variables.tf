...
variable "private_subnet_cidr" {
  description = "CIDR for the private subnet (AIG instance)"
  type        = string
  default     = "10.0.1.0/24"
}

variable "aig_private_ip" {
  description = "Fixed private IP for the AIG instance — must be within private_subnet_cidr. Used to register the host in Netskope before EC2 exists."
  type        = string
  default     = "10.0.1.10"
}
